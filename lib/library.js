...
function smsg(fell, m, store) {
	...
	if (m.message) {
		...
		if (m.quoted) {
			...
			m.quoted.reply = (text, chatId = m.chat, options = {}) => (Buffer.isBuffer(text) ? fell.sendFile(chatId, text, "file", "", m.quoted.fakeObj, { ...options }) : fell.sendText(chatId, text, m.quoted.fakeObj, { ...options }));
